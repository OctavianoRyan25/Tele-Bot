...
public class user extends javax.swing.JFrame {
    ...
    private void tampilData(){
        try{
            Object[] judul_kolom = {"ID","Chat ID", "username"};
   ...
   void tblKeForm(){
       jTextID.setText(tabModel.getValueAt(TabelProduk.getSelectedRow(),0)+"");
        ...
        jTextUsername.setText(tabModel.getValueAt(TabelProduk.getSelectedRow(),2)+"");
   ...
   private void seteditOn(){
    ...
    private void initComponents() {
        ...
        jLabelHeader.setText("Data Member");
        jLabelHeader.setOpaque(true);

        jLabelKodeProduk.setText("Chat ID");

        jLabelNama.setText("Username");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(jTextUsername, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 257, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    ...
                                    .addComponent(jTextID, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 258, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(6, 6, 6)
    ...
    private void jButtonSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaveActionPerformed
        ...
        if (ChatID.isEmpty() ) {
            ...
            try{
                Connection conn=(Connection)koneksi.koneksiDB();
                Statement stt=conn.createStatement();
                stt.executeUpdate("INSERT INTO users (chat_id, username)" + "VALUES('"+ChatID+"','"+Username+"')");
                BersihData();
                tampilData();
                SetEditOff();
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        ...
        if (ChatID.isEmpty() ) {
            ...
            try{
                Connection conn=(Connection)koneksi.koneksiDB();
                Statement stt=conn.createStatement();
                stt.executeUpdate("UPDATE users SET chat_id='"+ChatID+"', username='"+Username+"' "
                        + "WHERE id='"+ID+"'");
                BersihData();
                tampilData();
                SetEditOff();
